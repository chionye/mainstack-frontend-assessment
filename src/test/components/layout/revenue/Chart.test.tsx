...
describe('Chart', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render with single transaction', () => {
      expect(() => render(<Chart data={[mockTransactions[0]]} />)).not.toThrow()
    })
  ...
  describe('Data Processing', () => {
    ...
    it('should handle invalid date gracefully', () => {
      ...
      expect(() => render(<Chart data={dataWithInvalidDate} />)).not.toThrow()
    })
  })
  ...
  describe('Data Transformation', () => {
    it('should filter transactions with zero or negative amounts', () => {
      const mixedData: Transaction[] = [
        ...
        { ...mockTransactions[2], amount: -100, payment_reference: 'ref-negative' },
      ]
  ...
  describe('Component Structure', () => {
    it('should render with Box wrapper', () => {
      ...
      const box = container.querySelector('[class*="chakra"]')
